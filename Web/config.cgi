t <html><head><title>Configuración de Accesos</title></head>
i pg_header.inc
t 	<tr><th>
t 		<div style="width:900 background-image:url(fondo.png);">
t 			<div style="height: 25;"></div>
t 			<p style="font-size: 30;"><b>Configuración de Accesos</b></p>
